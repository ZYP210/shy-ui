...
const _hoisted_4$5 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ createElementVNode("p", { class: "error-modal-desc" }, "以下内容不完善，需进行修改", -1));
const _hoisted_5$5 = { class: "error-modal-list" };
const _hoisted_6$4 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ createElementVNode("div", { class: "error-modal-item-label" }, "流程设计", -1));
      ...
      return openBlock(), createBlock(unref(Modal), {
        ...
        footer: withCtx(() => [
          createVNode(unref(Button), {
            onClick: _cache[0] || (_cache[0] = ($event) => isRef(visibleDialog) ? visibleDialog.value = false : visibleDialog = false)
          }, {
            default: withCtx(() => [
          ...
          createVNode(unref(Button), {
            type: "primary",
            onClick: _cache[1] || (_cache[1] = ($event) => isRef(visibleDialog) ? visibleDialog.value = false : visibleDialog = false)
          }, {
            default: withCtx(() => [
              createTextVNode("前往修改")
            ]),
            _: 1
          })
        ]),
                ...
                createElementVNode("div", _hoisted_5$5, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(__props.list, (item, index) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      _hoisted_6$4,
                      createElementVNode("div", _hoisted_7$3, toDisplayString(item.name) + " 未选择" + toDisplayString(item.type), 1)
                    ]);
                  }), 128))
                ])
              ])
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Table), {
        ...
        bodyCell: withCtx(({ text, record, index, column }) => [
          ["label"].includes(column.dataIndex) ? (openBlock(), createElementBlock("span", _hoisted_1$6, toDisplayString(text), 1)) : (openBlock(), createBlock(unref(RadioGroup), {
            key: 1,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Drawer), {
        ...
        default: withCtx(() => [
          ...
          type.value == 2 ? (openBlock(), createBlock(AuthorityTable, {
            key: 0,
            fieldPermissions: fieldPermissions.value,
...
var Icon = function Icon2(props, context) {
  ...
  return createVNode("span", _objectSpread$c({
    "role": "img",
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Drawer), {
        ...
        default: withCtx(() => [
          ...
          type.value === "1" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            createVNode(unref(Form), {
              ...
              default: withCtx(() => [
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(approvalList.value, (item, index) => {
                  return openBlock(), createBlock(unref(Space), {
                    style: { "display": "flex", "margin-bottom": "8px" },
                    align: "baseline"
                  }, {
                    default: withCtx(() => [
                      createVNode(unref(FormItem), { label: "类型" }, {
                        default: withCtx(() => [
                          createVNode(unref(Select), {
                            value: item.type,
                            "onUpdate:value": ($event) => item.type = $event,
                            options: unref(approveTypes),
                            style: { "width": "130px" },
                            placeholder: "请选择类型",
                      ...
                      createVNode(unref(FormItem), { label: "值" }, {
                        default: withCtx(() => {
                          var _a, _b, _c, _d;
                          return [
                            !((_a = unref(ruleTypeDic)[item.type]) == null ? void 0 : _a.component) ? (openBlock(), createBlock(unref(Select), {
                              key: 0,
                              value: item.options,
                              ...
                              labelInValue: true,
                              fieldNames: (_b = unref(ruleTypeDic)[item.type]) == null ? void 0 : _b.fieldNames,
                              treeCheckStrictly: "",
                              "show-checked-strategy": unref(TreeSelect).SHOW_ALL,
                              "filter-option": filterOption,
                              onChange: ($event) => valueChange($event, item)
                            }, null, 8, ["value", "onUpdate:value", "options", "fieldNames", "show-checked-strategy", "onChange"])) : createCommentVNode("", true),
                            ((_c = unref(ruleTypeDic)[item.type]) == null ? void 0 : _c.component) ? (openBlock(), createBlock(unref(TreeSelect), {
                              key: 1,
                              value: item.options,
                              "onUpdate:value": ($event) => item.options = $event,
                              style: { "width": "200px" },
                              ...
                              placeholder: "请选择",
                              labelInValue: true,
                              fieldNames: (_d = unref(ruleTypeDic)[item.type]) == null ? void 0 : _d.fieldNames,
                              treeCheckStrictly: "",
                              "show-checked-strategy": unref(TreeSelect).SHOW_ALL,
                              "tree-node-filter-prop": "deptName",
                              onChange: ($event) => valueChange($event, item)
                            }, null, 8, ["value", "onUpdate:value", "tree-data", "fieldNames", "show-checked-strategy", "onChange"])) : createCommentVNode("", true)
                          ];
                        }),
                        _: 2
                      }, 1024)
            ...
            approvalList.value[0] && approvalList.value[0].type ? (openBlock(), createElementBlock("div", _hoisted_3$4, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(approvalList.value, (node) => {
                var _a;
                return openBlock(), createElementBlock("div", _hoisted_4$4, [
                  createTextVNode(toDisplayString((_a = unref(approveTypes).find((type2) => node.type == type2.value)) == null ? void 0 : _a.label) + "： ", 1),
                  (openBlock(true), createElementBlock(Fragment, null, renderList(node.options, (value) => {
                    return openBlock(), createElementBlock("span", _hoisted_5$4, toDisplayString(getOptionsLabel(node.type, value)), 1);
                  }), 256))
                ]);
              }), 256))
            ])) : createCommentVNode("", true)
          ], 64)) : (openBlock(), createBlock(AuthorityTable, {
            key: 1,
            fieldPermissions: fieldPermissions.value,
            "onUpdate:fieldPermissions": _cache[1] || (_cache[1] = ($event) => fieldPermissions.value = $event),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(Drawer), {
        ...
        default: withCtx(() => [
          createVNode(unref(Form), { ref: "formRef" }, {
            default: withCtx(() => [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(conditionList), (item, index) => {
                return openBlock(), createBlock(unref(Space), {
                  style: { "display": "flex", "margin-bottom": "8px" },
                  align: "baseline"
                }, {
                  default: withCtx(() => [
                    ...
                    createVNode(unref(MinusCircleOutlined$1), {
      ...
      return openBlock(), createBlock(unref(Drawer), {
        ...
        default: withCtx(() => [
          createVNode(unref(Form), null, {
            default: withCtx(() => [
              createVNode(unref(FormItem), mergeProps({ label: "条件组表达式" }, unref(validateInfos).expression, { extra: "使用表达式构建复杂逻辑，例如：（A & B) | C" }), {
                default: withCtx(() => [
                  createVNode(unref(Input), {
...
const _hoisted_6$3 = /* @__PURE__ */ createElementVNode("div", { class: "end-node" }, [
  /* @__PURE__ */ createElementVNode("div", { class: "end-node-circle" }),
  /* @__PURE__ */ createElementVNode("div", { class: "end-node-text" }, "流程结束")
], -1);
const _hoisted_7$2 = /* @__PURE__ */ createElementVNode("div", { class: "end-node" }, [
  /* @__PURE__ */ createElementVNode("div", { class: "end-node-circle" }),
  /* @__PURE__ */ createElementVNode("div", { class: "end-node-text" }, "流程结束")
], -1);
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      const _component_nodeWrap = resolveComponent("nodeWrap");
      const _component_displayNodeWrap = resolveComponent("displayNodeWrap");
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createElementVNode("div", _hoisted_2$3, [
          createVNode(unref(Button), {
            ...
            default: withCtx(() => [
              !__props.option.isLook ? (openBlock(), createElementBlock("span", _hoisted_3$3, "发 布")) : createCommentVNode("", true)
            ]),
            _: 1
          }),
          createElementVNode("section", _hoisted_4$3, [
            !__props.option.isLook ? (openBlock(), createElementBlock("div", _hoisted_5$3, [
              createElementVNode("div", {
                class: normalizeClass(["zoom-out", unref(nowVal) == 50 && "disabled"]),
                onClick: _cache[0] || (_cache[0] = ($event) => zoomSize(1))
              }, null, 2),
              createElementVNode("span", null, toDisplayString(unref(nowVal)) + "%", 1),
              createElementVNode("div", {
                class: normalizeClass(["zoom-in", unref(nowVal) == 300 && "disabled"]),
                onClick: _cache[1] || (_cache[1] = ($event) => zoomSize(2))
              }, null, 2)
            ])) : createCommentVNode("", true),
            !__props.option.isStatus ? (openBlock(), createElementBlock("div", {
              key: 1,
              class: normalizeClass(["box-scale", __props.option.isLook ? "no-click" : ""]),
              style: normalizeStyle(`transform: scale(${unref(nowVal) / 100});`)
            }, [
              createVNode(_component_nodeWrap, {
              ...
              createVNode(_component_displayNodeWrap, {
                class: "display",
                nodeConfig: unref(nodeConfig),
                "onUpdate:nodeConfig": _cache[4] || (_cache[4] = ($event) => isRef(nodeConfig) ? nodeConfig.value = $event : nodeConfig = $event),
                rootFieldPermissions: rootFieldPermissions.value,
        ...
        createVNode(errorDialog, {
          visible: unref(tipVisible),
          "onUpdate:visible": _cache[6] || (_cache[6] = ($event) => isRef(tipVisible) ? tipVisible.value = $event : tipVisible = $event),
          list: unref(tipList)
        }, null, 8, ["visible", "list"]),
        createVNode(promoterDrawer),
        createVNode(approverDrawer),
...
const _hoisted_19$1 = /* @__PURE__ */ createElementVNode("div", { class: "top-left-cover-line" }, null, -1);
const _hoisted_20$1 = /* @__PURE__ */ createElementVNode("div", { class: "bottom-left-cover-line" }, null, -1);
const _hoisted_21$1 = /* @__PURE__ */ createElementVNode("div", { class: "top-right-cover-line" }, null, -1);
const _hoisted_22$1 = /* @__PURE__ */ createElementVNode("div", { class: "bottom-right-cover-line" }, null, -1);
const _sfc_main$2 = {
  __name: "nodeWrap",
  props: {
    nodeConfig: {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const setPerson = (priorityLevel) => {
      ...
      const hasVal = (_b = toRaw((_a = flowPermission1.value) == null ? void 0 : _a.fieldPermissions)) == null ? void 0 : _b.length;
      if (type == 1) {
        setPromoter(true);
        if (hasVal)
          return;
    ...
    return (_ctx, _cache) => {
      const _component_addNode = resolveComponent("addNode");
      const _component_nodeWrap = resolveComponent("nodeWrap", true);
      const _directive_focus = resolveDirective("focus");
      return openBlock(), createElementBlock(Fragment, null, [
        [1, 2, 3, 4].includes(__props.nodeConfig.type) ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
          createElementVNode("div", {
            class: normalizeClass(["node-wrap-box", (__props.nodeConfig.type == 1 ? "start-node " : "") + (unref(isTried) && __props.nodeConfig.error ? "active error" : "")])
          }, [
            createElementVNode("div", {
              class: "title",
              style: normalizeStyle(`background: rgb(${unref(bgColors)[__props.nodeConfig.type]});`)
            }, [
              __props.nodeConfig.type == 1 ? (openBlock(), createElementBlock("span", _hoisted_2$2, toDisplayString(__props.nodeConfig.nodeName), 1)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                createElementVNode("span", _hoisted_3$2, [
                  __props.nodeConfig.type == 2 ? (openBlock(), createBlock(unref(UserOutlined$1), { key: 0 })) : __props.nodeConfig.type == 3 ? (openBlock(), createBlock(unref(ControlOutlined$1), { key: 1 })) : createCommentVNode("", true)
                ]),
                unref(isInput) ? withDirectives((openBlock(), createBlock(unref(Input), {
                  key: 0,
                  style: { "width": "120px" },
                ...
                }, toDisplayString(__props.nodeConfig.nodeName), 1)),
                createVNode(unref(CloseOutlined$1), {
                  class: "close",
                  onClick: withModifiers(delNode, ["stop"])
                })
              ], 64))
            ], 4),
            createElementVNode("div", {
              ...
              createElementVNode("div", _hoisted_4$2, [
                !unref(showText) ? (openBlock(), createElementBlock("span", _hoisted_5$2, "请选择" + toDisplayString(unref(defaultText)), 1)) : createCommentVNode("", true),
                createTextVNode(" " + toDisplayString(unref(showText)), 1)
              ]),
              createVNode(unref(RightOutlined$1), { class: "content-close" })
            ]),
            unref(isTried) && __props.nodeConfig.error ? (openBlock(), createElementBlock("div", _hoisted_6$2, [
              createVNode(unref(InfoCircleOutlined$1))
            ])) : createCommentVNode("", true)
          ], 2),
          createVNode(_component_addNode, {
            childNodeP: __props.nodeConfig.childNode,
            "onUpdate:childNodeP": _cache[4] || (_cache[4] = ($event) => __props.nodeConfig.childNode = $event)
          }, null, 8, ["childNodeP"])
        ])) : createCommentVNode("", true),
        __props.nodeConfig.type == 5 ? (openBlock(), createElementBlock("div", _hoisted_7$1, [
          createElementVNode("div", _hoisted_8$1, [
            createElementVNode("div", _hoisted_9$1, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(__props.nodeConfig.conditionNodes, (item, index) => {
                return openBlock(), createElementBlock("div", {
                  class: "col-box",
                  key: index
                }, [
                  createElementVNode("div", _hoisted_10$1, [
                    createElementVNode("div", _hoisted_11$1, [
                      createElementVNode("div", {
                        class: normalizeClass(["auto-judge", unref(isTried) && item.error ? "error active" : ""])
                      }, [
                        ...
                        createElementVNode("div", _hoisted_13$1, [
                          unref(isInputList)[index] ? withDirectives((openBlock(), createBlock(unref(Input), {
                            key: 0,
                            style: { "width": "120px" },
                            class: "ant-input editable-title-input",
                          ...
                          }, toDisplayString(item.nodeName), 9, _hoisted_14$1)),
                          createElementVNode("span", {
                            class: "priority-title",
                            onClick: ($event) => setPerson(item.priorityLevel)
                          }, "优先级" + toDisplayString(item.priorityLevel), 9, _hoisted_15$1),
                          createVNode(unref(CloseOutlined$1), {
                            class: "close",
                            onClick: withModifiers(($event) => delTerm(index, "条件"), ["stop"])
                          }, null, 8, ["onClick"])
                        ]),
                        index != __props.nodeConfig.conditionNodes.length - 1 ? (openBlock(), createElementBlock("div", {
                          key: 1,
                          class: "sort-right",
                        ...
                        createElementVNode("div", {
                          class: "content",
                          onClick: ($event) => setPerson(item.priorityLevel)
                        }, toDisplayString(unref($func).conditionStr(__props.nodeConfig, index)), 9, _hoisted_17$1),
                        unref(isTried) && item.error ? (openBlock(), createElementBlock("div", _hoisted_18$1, [
                          createVNode(unref(InfoCircleOutlined$1))
                        ])) : createCommentVNode("", true)
                      ], 2),
                      createVNode(_component_addNode, {
                  ...
                  item.childNode ? (openBlock(), createBlock(_component_nodeWrap, {
                    key: 0,
                  ...
                  index == 0 ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                    _hoisted_19$1,
                    _hoisted_20$1
                  ], 64)) : createCommentVNode("", true),
                  index == __props.nodeConfig.conditionNodes.length - 1 ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
                    _hoisted_21$1,
                    _hoisted_22$1
                  ], 64)) : createCommentVNode("", true)
                ]);
...
const _hoisted_4$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createElementVNode("span", { class: "title" }, "审批人", -1));
const _hoisted_5$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createElementVNode("span", { class: "title" }, "条件分支", -1));
const _hoisted_6$1 = {
  class: "btn",
  type: "button"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createElementVNode("div", _hoisted_2$1, [
          !unref(isLook) ? (openBlock(), createBlock(unref(Popover), {
            key: 0,
            ...
            content: withCtx(() => [
              createElementVNode("ul", _hoisted_3$1, [
                hasNode.value(2) ? (openBlock(), createElementBlock("li", {
                  key: 0,
                  onClick: _cache[0] || (_cache[0] = ($event) => addType(2))
                }, [
                  createVNode(unref(TeamOutlined$1), {
                    class: "icon",
                    style: { "color": "rgb(255, 148, 62)" }
                  }),
                  _hoisted_4$1
                ])) : createCommentVNode("", true),
                hasNode.value(5) ? (openBlock(), createElementBlock("li", {
                  key: 1,
                  onClick: _cache[1] || (_cache[1] = ($event) => addType(5))
                }, [
                  createVNode(unref(ShareAltOutlined$1), {
                    class: "icon",
            ...
            default: withCtx(() => [
              createElementVNode("button", _hoisted_6$1, [
                createVNode(unref(PlusOutlined$1), { class: "iconfont" })
              ])
            ]),
            _: 1
...
const _hoisted_9 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("button", { class: "add-branch" }, "条件", -1));
...
const _hoisted_15 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("div", { class: "top-left-cover-line" }, null, -1));
const _hoisted_16 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("div", { class: "bottom-left-cover-line" }, null, -1));
const _hoisted_17 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("div", { class: "top-right-cover-line" }, null, -1));
const _hoisted_18 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("div", { class: "bottom-right-cover-line" }, null, -1));
const _hoisted_19 = {
  key: 2,
  class: "branch-wrap"
};
...
const _hoisted_22 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("button", { class: "add-branch" }, "分支", -1));
...
const _hoisted_28 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("div", { class: "top-left-cover-line" }, null, -1));
const _hoisted_29 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("div", { class: "bottom-left-cover-line" }, null, -1));
const _hoisted_30 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("div", { class: "top-right-cover-line" }, null, -1));
const _hoisted_31 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("div", { class: "bottom-right-cover-line" }, null, -1));
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_addNode = resolveComponent("addNode");
      const _component_displayNodeWrap = resolveComponent("displayNodeWrap", true);
      return openBlock(), createElementBlock(Fragment, null, [
        [0, 1, 2, 5].includes(__props.nodeConfig.type) ? (openBlock(), createElementBlock("div", _hoisted_1, [
          createElementVNode("div", {
            class: normalizeClass(["node-wrap-box", __props.nodeConfig.type == 0 ? "start-node " : ""]),
            style: normalizeStyle({ border: `1px solid ${unref(bgColors)[__props.nodeConfig.completeState]}` })
          }, [
            createElementVNode("div", {
              class: "title",
              style: normalizeStyle({ background: unref(bgColors)[__props.nodeConfig.completeState] })
            }, [
              createElementVNode("span", _hoisted_2, [
                __props.nodeConfig.completeState === 1 ? (openBlock(), createBlock(unref(ClockCircleOutlined$1), { key: 0 })) : __props.nodeConfig.completeState === 2 ? (openBlock(), createBlock(unref(FileOutlined$1), { key: 1 })) : (openBlock(), createBlock(unref(NodeIndexOutlined$1), { key: 2 }))
              ]),
              createElementVNode("span", null, toDisplayString(__props.nodeConfig.nodeName), 1)
            ], 4),
            createElementVNode("div", _hoisted_3, [
              createElementVNode("div", _hoisted_4, [
                !unref(showText) ? (openBlock(), createElementBlock("span", _hoisted_5, "请选择" + toDisplayString(unref(defaultText)), 1)) : createCommentVNode("", true),
                createTextVNode(" " + toDisplayString(unref(showText)), 1)
              ])
            ])
          ], 6),
        ...
        __props.nodeConfig.type == 4 ? (openBlock(), createElementBlock("div", _hoisted_6, [
            ...
            createElementVNode("div", _hoisted_8, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(__props.nodeConfig.conditionNodes, (item, index) => {
                return openBlock(), createElementBlock("div", {
                    ...
                    createElementVNode("div", _hoisted_11, [
                      createElementVNode("div", {
                        ...
                        createElementVNode("div", {
                          ...
                          createElementVNode("span", _hoisted_13, toDisplayString(item.nodeName), 1)
                        ], 4),
                        createElementVNode("div", _hoisted_14, toDisplayString(unref($func).conditionStr(__props.nodeConfig, index)), 1)
                      ], 4),
                      createVNode(_component_addNode, {
                        childNodeP: item.childNode,
                        "onUpdate:childNodeP": ($event) => item.childNode = $event
                  ...
                  item.childNode ? (openBlock(), createBlock(_component_displayNodeWrap, {
                    key: 0,
                    nodeConfig: item.childNode,
                    "onUpdate:nodeConfig": ($event) => item.childNode = $event
                  }, null, 8, ["nodeConfig", "onUpdate:nodeConfig"])) : createCommentVNode("", true),
        ...
        __props.nodeConfig.type == 3 ? (openBlock(), createElementBlock("div", _hoisted_19, [
                    ...
                    createElementVNode("div", _hoisted_24, [
                      createElementVNode("div", {
                        ...
                        createElementVNode("div", {
                          ...
                          createElementVNode("span", _hoisted_26, toDisplayString(item.nodeName), 1)
                        ], 4),
                        createElementVNode("div", _hoisted_27, toDisplayString(unref($func).conditionStr(__props.nodeConfig, index)), 1)
                      ], 4),
                      createVNode(_component_addNode, {
                        childNodeP: item.childNode,
                        "onUpdate:childNodeP": ($event) => item.childNode = $event
        ...
        __props.nodeConfig.childNode ? (openBlock(), createBlock(_component_displayNodeWrap, {
          key: 3,
          nodeConfig: __props.nodeConfig.childNode,

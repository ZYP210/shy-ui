...
const _withScopeId$3 = (n) => (vue.pushScopeId("data-v-dd6bfc52"), n = n(), vue.popScopeId(), n);
...
const _hoisted_4$5 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("p", { class: "error-modal-desc" }, "以下内容不完善，需进行修改", -1));
const _hoisted_5$5 = { class: "error-modal-list" };
const _hoisted_6$4 = /* @__PURE__ */ _withScopeId$3(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "error-modal-item-label" }, "流程设计", -1));
const _hoisted_7$3 = { class: "error-modal-item-content" };
const _sfc_main$a = {
  __name: "errorDialog",
  props: {
    list: {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Modal), {
        open: vue.unref(visibleDialog),
        "onUpdate:open": _cache[2] || (_cache[2] = ($event) => vue.isRef(visibleDialog) ? visibleDialog.value = $event : visibleDialog = $event),
        title: "提示",
        width: 650
      }, {
        footer: vue.withCtx(() => [
          vue.createVNode(vue.unref(antDesignVue.Button), {
            onClick: _cache[0] || (_cache[0] = ($event) => vue.isRef(visibleDialog) ? visibleDialog.value = false : visibleDialog = false)
          }, {
            default: vue.withCtx(() => [
              vue.createTextVNode("我知道了")
            ]),
            _: 1
          }),
          vue.createVNode(vue.unref(antDesignVue.Button), {
            type: "primary",
            onClick: _cache[1] || (_cache[1] = ($event) => vue.isRef(visibleDialog) ? visibleDialog.value = false : visibleDialog = false)
          }, {
            default: vue.withCtx(() => [
              vue.createTextVNode("前往修改")
            ]),
            _: 1
          })
        ]),
                ...
                vue.createElementVNode("div", _hoisted_5$5, [
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.list, (item, index) => {
                    return vue.openBlock(), vue.createElementBlock("div", {
                      ...
                      _hoisted_6$4,
                      vue.createElementVNode("div", _hoisted_7$3, vue.toDisplayString(item.name) + " 未选择" + vue.toDisplayString(item.type), 1)
                    ]);
                  }), 128))
                ])
              ])
...
var Store = function Store2(options) {
  ...
  var useDevtools = options.devtools !== void 0 ? options.devtools : (
    /* Vue.config.devtools */
    true
  );
  if (useDevtools) {
...
const mapState = () => {
  ...
  return Object.fromEntries(
    Object.keys(store2.state).map((key) => [
      key,
      vue.computed(() => store2.state[key])
    ])
  );
};
const mapMutations = () => {
  const store2 = useStore();
  return Object.fromEntries(
    Object.keys(store2._mutations).map((mutation) => [
      mutation,
      (value) => store2.commit(mutation, value)
    ])
  );
};
const _hoisted_1$6 = { key: 0 };
const _sfc_main$9 = /* @__PURE__ */ vue.defineComponent({
  __name: "authorityTable",
  props: {
    fieldPermissions: {
      type: Array,
      default: () => []
  ...
  setup(__props, { emit: __emit }) {
    ...
    const data = [];
    props.fieldPermissions.forEach((res) => {
      const obj = {};
    ...
    try {
      for (let i = 0; i < data.length; i++) {
        ...
        for (const key in curr) {
          if (curr[key] === key && props.fieldPermissions[i][key] === true) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Table), {
        ...
        bodyCell: vue.withCtx(({ text, record, index, column }) => [
          ["label"].includes(column.dataIndex) ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_1$6, vue.toDisplayString(text), 1)) : (vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.RadioGroup), {
            key: 1,
            value: checkList.value[index],
            "onUpdate:value": ($event) => checkList.value[index] = $event
          }, {
            default: vue.withCtx(() => [
              vue.createVNode(vue.unref(antDesignVue.Radio), {
...
const _sfc_main$8 = {
  ...
  setup(__props) {
    mapState();
    const type = vue.ref("2");
    let { promoterDrawer: promoterDrawer2, flowPermission1 } = mapState();
    let visible = vue.computed({
      get() {
        type.value = "2";
        return promoterDrawer2.value;
      },
      set() {
        closeDrawer();
      }
    });
    const fieldPermissions = vue.ref([]);
    vue.watch(flowPermission1, (val) => {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Drawer), {
        open: vue.unref(visible),
        "onUpdate:open": _cache[2] || (_cache[2] = ($event) => vue.isRef(visible) ? visible.value = $event : visible = $event),
        class: "set_promoter",
        width: 550,
        title: "发起人",
        placement: "right",
        ...
        default: vue.withCtx(() => [
          vue.createElementVNode("div", _hoisted_1$5, [
            vue.createVNode(vue.unref(antDesignVue.RadioGroup), {
              ...
              default: vue.withCtx(() => [
                vue.createVNode(vue.unref(antDesignVue.RadioButton), {
                  class: "btn",
                  value: "2"
                }, {
                  default: vue.withCtx(() => [
                    vue.createTextVNode("设置字段权限")
                  ]),
                  _: 1
                })
              ]),
          ...
          type.value == 2 ? (vue.openBlock(), vue.createBlock(AuthorityTable, {
            key: 0,
            fieldPermissions: fieldPermissions.value,
            "onUpdate:fieldPermissions": _cache[1] || (_cache[1] = ($event) => fieldPermissions.value = $event)
          }, null, 8, ["fieldPermissions"])) : vue.createCommentVNode("", true)
        ]),
        _: 1
      }, 8, ["open"]);
    };
...
function _objectSpread$e(target2) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    ownKeys.forEach(function(key) {
      _defineProperty$e(target2, key, source[key]);
    });
  }
  return target2;
}
...
function generate(node, key, rootProps) {
  if (!rootProps) {
    return vue.h(node.tag, _objectSpread$e({
      key
...
function _objectWithoutProperties$1(source, excluded) {
  if (source == null)
    return {};
  var target2 = _objectWithoutPropertiesLoose$1(source, excluded);
  var key, i;
...
function _objectSpread$d(target2) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    ownKeys.forEach(function(key) {
      _defineProperty$d(target2, key, source[key]);
    });
  }
  return target2;
}
...
var IconBase = function IconBase2(props, context) {
  var _props$context$attrs = _objectSpread$d({}, props, context.attrs), icon = _props$context$attrs.icon, primaryColor = _props$context$attrs.primaryColor, secondaryColor = _props$context$attrs.secondaryColor, restProps = _objectWithoutProperties$1(_props$context$attrs, _excluded$1);
  ...
  if (target2 && typeof target2.icon === "function") {
    target2 = _objectSpread$d({}, target2, {
      icon: target2.icon(colors.primaryColor, colors.secondaryColor)
    });
  }
  return generate(target2.icon, "svg-".concat(target2.name), _objectSpread$d({}, restProps, {
...
function _objectSpread$c(target2) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    ownKeys.forEach(function(key) {
      _defineProperty$c(target2, key, source[key]);
    });
  }
  return target2;
}
...
var Icon = function Icon2(props, context) {
  ...
  return vue.createVNode("span", _objectSpread$c({
    "role": "img",
...
function _objectSpread$b(target2) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    ownKeys.forEach(function(key) {
      _defineProperty$b(target2, key, source[key]);
    });
  }
  return target2;
}
...
function _objectSpread$9(target2) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    ownKeys.forEach(function(key) {
      _defineProperty$9(target2, key, source[key]);
    });
  }
  return target2;
}
...
var ControlOutlined = function ControlOutlined2(props, context) {
...
const ControlOutlined$1 = ControlOutlined;
...
function _objectSpread$7(target2) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    ownKeys.forEach(function(key) {
      _defineProperty$7(target2, key, source[key]);
    });
  }
  return target2;
}
...
function _objectSpread$6(target2) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    ownKeys.forEach(function(key) {
      _defineProperty$6(target2, key, source[key]);
    });
  }
  return target2;
}
...
var MinusCircleOutlined = function MinusCircleOutlined2(props, context) {
...
const MinusCircleOutlined$1 = MinusCircleOutlined;
var NodeIndexOutlined$2 = { "icon": { "tag": "svg", "attrs": { "viewBox": "64 64 896 896", "focusable": "false" }, "children": [{ "tag": "defs", "attrs": {}, "children": [{ "tag": "style", "attrs": {} }] }, { "tag": "path", "attrs": { "d": "M843.5 737.4c-12.4-75.2-79.2-129.1-155.3-125.4S550.9 676 546 752c-153.5-4.8-208-40.7-199.1-113.7 3.3-27.3 19.8-41.9 50.1-49 18.4-4.3 38.8-4.9 57.3-3.2 1.7.2 3.5.3 5.2.5 11.3 2.7 22.8 5 34.3 6.8 34.1 5.6 68.8 8.4 101.8 6.6 92.8-5 156-45.9 159.2-132.7 3.1-84.1-54.7-143.7-147.9-183.6-29.9-12.8-61.6-22.7-93.3-30.2-14.3-3.4-26.3-5.7-35.2-7.2-7.9-75.9-71.5-133.8-147.8-134.4-76.3-.6-140.9 56.1-150.1 131.9s40 146.3 114.2 163.9c74.2 17.6 149.9-23.3 175.7-95.1 9.4 1.7 18.7 3.6 28 5.8 28.2 6.6 56.4 15.4 82.4 26.6 70.7 30.2 109.3 70.1 107.5 119.9-1.6 44.6-33.6 65.2-96.2 68.6-27.5 1.5-57.6-.9-87.3-5.8-8.3-1.4-15.9-2.8-22.6-4.3-3.9-.8-6.6-1.5-7.8-1.8l-3.1-.6c-2.2-.3-5.9-.8-10.7-1.3-25-2.3-52.1-1.5-78.5 4.6-55.2 12.9-93.9 47.2-101.1 105.8-15.7 126.2 78.6 184.7 276 188.9 29.1 70.4 106.4 107.9 179.6 87 73.3-20.9 119.3-93.4 106.9-168.6zM329.1 345.2a83.3 83.3 0 11.01-166.61 83.3 83.3 0 01-.01 166.61zM695.6 845a83.3 83.3 0 11.01-166.61A83.3 83.3 0 01695.6 845z" } }] }, "name": "node-index", "theme": "outlined" };
const NodeIndexOutlinedSvg = NodeIndexOutlined$2;
function _objectSpread$5(target2) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    ownKeys.forEach(function(key) {
      _defineProperty$5(target2, key, source[key]);
    });
  }
  return target2;
}
...
var NodeIndexOutlined = function NodeIndexOutlined2(props, context) {
...
var ShareAltOutlined = function ShareAltOutlined2(props, context) {
...
const ShareAltOutlined$1 = ShareAltOutlined;
...
const TeamOutlined$1 = TeamOutlined;
...
All.prototype = {
  ...
  conditionStr(nodeConfig, index) {
    ...
    if (!expression) {
      return index == nodeConfig.conditionNodes.length - 1 && nodeConfig.conditionNodes[0].expression ? type === 3 ? "其他分支并行执行" : "其他条件进入此流程" : type === 3 ? "请设置分支" : "请设置条件";
    } else {
      return expression;
    }
  },
  ...
  handleTree(data, id, parentId, children) {
    ...
    const tree = [];
    for (const d of data) {
      const parentId2 = d[config.parentId];
...
const _withScopeId$2 = (n) => (vue.pushScopeId("data-v-73d45195"), n = n(), vue.popScopeId(), n);
...
const _hoisted_4$4 = { class: "list-col" };
const _hoisted_5$4 = { class: "list-row" };
const _sfc_main$7 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const getOptions = (type2) => {
      return type2 ? ruleTypeDic[type2].options.value : [];
    };
    const getOptionsLabel = (type2, value) => {
      var _a;
      const options = ((_a = ruleTypeDic[type2]) == null ? void 0 : _a.options) ?? [];
      const fieldNames = ruleTypeDic[type2].fieldNames;
      const result = $func.findTreeNode(options.value, (node) => {
        return node[(fieldNames == null ? void 0 : fieldNames.value) || "value"] == value;
      });
      return result[(fieldNames == null ? void 0 : fieldNames.label) || "label"];
    };
    const filterOption = (inputValue, option) => {
      return option.label.toLowerCase().indexOf(inputValue.toLowerCase()) > -1;
    };
    const approvalList = vue.ref([]);
    ...
    const fieldPermissions = vue.ref([]);
    vue.watch(approverConfig1, (val) => {
      var _a, _b;
      fieldPermissions.value = val.value.fieldPermissions;
      if (((_b = (_a = val.value) == null ? void 0 : _a.approvalList) == null ? void 0 : _b.length) > 0) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Drawer), {
        ...
        default: vue.withCtx(() => [
          ...
          type.value === "1" ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
            vue.createVNode(vue.unref(antDesignVue.Form), {
              ...
              default: vue.withCtx(() => [
                ...
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(approvalList.value, (item, index) => {
                  return vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Space), {
                    style: { "display": "flex", "margin-bottom": "8px" },
                    align: "baseline"
                  }, {
                    default: vue.withCtx(() => [
                      vue.createVNode(vue.unref(antDesignVue.FormItem), { label: "类型" }, {
                        default: vue.withCtx(() => [
                          vue.createVNode(vue.unref(antDesignVue.Select), {
                            value: item.type,
                            "onUpdate:value": ($event) => item.type = $event,
                            options: vue.unref(approveTypes),
                            style: { "width": "130px" },
                            placeholder: "请选择类型",
                            onChange: ($event) => selectChange($event, item)
                          }, null, 8, ["value", "onUpdate:value", "options", "onChange"])
                        ]),
                        _: 2
                      }, 1024),
                      vue.createVNode(vue.unref(antDesignVue.FormItem), { label: "值" }, {
                        default: vue.withCtx(() => {
                          var _a, _b, _c, _d;
                          return [
                            !((_a = vue.unref(ruleTypeDic)[item.type]) == null ? void 0 : _a.component) ? (vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Select), {
                              key: 0,
                              value: item.options,
                              "onUpdate:value": ($event) => item.options = $event,
                              mode: "multiple",
                              style: { "width": "200px" },
                              placeholder: "请选择",
                              options: getOptions(item.type),
                              labelInValue: true,
                              fieldNames: (_b = vue.unref(ruleTypeDic)[item.type]) == null ? void 0 : _b.fieldNames,
                              treeCheckStrictly: "",
                              "show-checked-strategy": vue.unref(antDesignVue.TreeSelect).SHOW_ALL,
                              "filter-option": filterOption,
                              onChange: ($event) => valueChange($event, item)
                            }, null, 8, ["value", "onUpdate:value", "options", "fieldNames", "show-checked-strategy", "onChange"])) : vue.createCommentVNode("", true),
                            ((_c = vue.unref(ruleTypeDic)[item.type]) == null ? void 0 : _c.component) ? (vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.TreeSelect), {
                              key: 1,
                              value: item.options,
                              "onUpdate:value": ($event) => item.options = $event,
                              style: { "width": "200px" },
                              ...
                              placeholder: "请选择",
                              labelInValue: true,
                              fieldNames: (_d = vue.unref(ruleTypeDic)[item.type]) == null ? void 0 : _d.fieldNames,
                              treeCheckStrictly: "",
                              "show-checked-strategy": vue.unref(antDesignVue.TreeSelect).SHOW_ALL,
                              "tree-node-filter-prop": "deptName",
                              onChange: ($event) => valueChange($event, item)
                            }, null, 8, ["value", "onUpdate:value", "tree-data", "fieldNames", "show-checked-strategy", "onChange"])) : vue.createCommentVNode("", true)
                          ];
                        }),
                        _: 2
                      }, 1024)
            ...
            approvalList.value[0] && approvalList.value[0].type ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$4, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(approvalList.value, (node) => {
                var _a;
                return vue.openBlock(), vue.createElementBlock("div", _hoisted_4$4, [
                  vue.createTextVNode(vue.toDisplayString((_a = vue.unref(approveTypes).find((type2) => node.type == type2.value)) == null ? void 0 : _a.label) + "： ", 1),
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(node.options, (value) => {
                    return vue.openBlock(), vue.createElementBlock("span", _hoisted_5$4, vue.toDisplayString(getOptionsLabel(node.type, value)), 1);
                  }), 256))
                ]);
              }), 256))
            ])) : vue.createCommentVNode("", true)
          ], 64)) : (vue.openBlock(), vue.createBlock(AuthorityTable, {
            key: 1,
            fieldPermissions: fieldPermissions.value,
            "onUpdate:fieldPermissions": _cache[1] || (_cache[1] = ($event) => fieldPermissions.value = $event),
...
const _sfc_main$6 = {
  __name: "copyerDrawer",
  setup(__props) {
    let copyerConfig = vue.ref({});
    let conditionList = vue.ref([]);
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Drawer), {
        open: vue.unref(visible),
        "onUpdate:open": _cache[0] || (_cache[0] = ($event) => vue.isRef(visible) ? visible.value = $event : visible = $event),
        class: "set_copyer",
        width: 550,
        title: "触发器",
        placement: "right",
        ...
        footer: vue.withCtx(() => [
          vue.createVNode(vue.unref(antDesignVue.Space), null, {
            default: vue.withCtx(() => [
              ...
              vue.createVNode(vue.unref(antDesignVue.Button), { onClick: closeDrawer }, {
                default: vue.withCtx(() => [
        ...
        default: vue.withCtx(() => [
          vue.createVNode(vue.unref(antDesignVue.Form), { ref: "formRef" }, {
            default: vue.withCtx(() => [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(conditionList), (item, index) => {
                return vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Space), {
                  style: { "display": "flex", "margin-bottom": "8px" },
                  align: "baseline"
                }, {
                  default: vue.withCtx(() => [
                    ...
                    vue.createVNode(vue.unref(MinusCircleOutlined$1), {
                      onClick: ($event) => removeSight(item),
                      class: "icon"
                    }, null, 8, ["onClick"])
                  ]),
                  _: 2
...
const _sfc_main$5 = {
  __name: "conditionDrawer",
  setup(__props) {
    const useForm = antDesignVue.Form.useForm;
    const modelRef = vue.reactive({ expression: "" });
    let conditionsConfig = vue.reactive({
      conditionNodes: []
    });
    let conditionConfig = vue.reactive({});
    let priorityLevel = vue.ref("");
    ...
    vue.watch(conditionsConfig1, (val) => {
      conditionsConfig = val.value;
      priorityLevel.value = val.priorityLevel;
      conditionConfig = val.priorityLevel ? conditionsConfig.conditionNodes[val.priorityLevel - 1] : { expression: "" };
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Drawer), {
        open: vue.unref(visible),
        "onUpdate:open": _cache[1] || (_cache[1] = ($event) => vue.isRef(visible) ? visible.value = $event : visible = $event),
        class: "set_promoter",
        width: 550,
        title: "条件设置",
        placement: "right",
        ...
        default: vue.withCtx(() => [
          vue.createVNode(vue.unref(antDesignVue.Form), null, {
            default: vue.withCtx(() => [
              vue.createVNode(vue.unref(antDesignVue.FormItem), vue.mergeProps({ label: "条件组表达式" }, vue.unref(validateInfos).expression, { extra: "使用表达式构建复杂逻辑，例如：（A & B) | C" }), {
                default: vue.withCtx(() => [
                  vue.createVNode(vue.unref(antDesignVue.Input), {
                    value: modelRef.expression,
                    "onUpdate:value": _cache[0] || (_cache[0] = ($event) => modelRef.expression = $event)
                  }, null, 8, ["value"])
                ]),
                _: 1
              }, 16)
...
const _hoisted_1$3 = { class: "dingflow-design-body" };
const _hoisted_2$3 = { class: "fd-nav-content" };
const _hoisted_3$3 = { key: 0 };
const _hoisted_4$3 = { class: "dingflow-design" };
const _hoisted_5$3 = {
  key: 0,
  class: "zoom"
};
const _hoisted_6$3 = /* @__PURE__ */ vue.createElementVNode("div", { class: "end-node" }, [
  /* @__PURE__ */ vue.createElementVNode("div", { class: "end-node-circle" }),
  /* @__PURE__ */ vue.createElementVNode("div", { class: "end-node-text" }, "流程结束")
], -1);
const _hoisted_7$2 = /* @__PURE__ */ vue.createElementVNode("div", { class: "end-node" }, [
  /* @__PURE__ */ vue.createElementVNode("div", { class: "end-node-circle" }),
  /* @__PURE__ */ vue.createElementVNode("div", { class: "end-node-text" }, "流程结束")
], -1);
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    let processConfig = vue.ref({});
    let nodeConfig = vue.ref({});
    let workName = vue.ref("");
    const rootFieldPermissions = vue.ref([]);
    const data = props.initData;
    processConfig.value = data;
    let { nodeConfig: nodes, name, deploymentId } = data;
    nodeConfig.value = !nodes || !Object.keys(nodes).length ? {
      nodeName: "发起人",
      type: 1,
      childNode: null,
    ...
    workName.value = name;
    rootFieldPermissions.value = nodes == null ? void 0 : nodes.fieldPermissions;
    ...
    const reErr = ({ type, childNode }) => {
      if (childNode) {
        let { type: type2, error, nodeName, conditionNodes } = childNode;
        if (type2 == 1 || type2 == 2) {
          if (error) {
            tipList.value.push({
              name: nodeName,
    ...
    return (_ctx, _cache) => {
      const _component_nodeWrap = vue.resolveComponent("nodeWrap");
      const _component_displayNodeWrap = vue.resolveComponent("displayNodeWrap");
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$3, [
        vue.createElementVNode("div", _hoisted_2$3, [
          vue.createVNode(vue.unref(antDesignVue.Button), {
            ...
            default: vue.withCtx(() => [
              !__props.option.isLook ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_3$3, "发 布")) : vue.createCommentVNode("", true)
            ]),
            _: 1
          }),
          vue.createElementVNode("section", _hoisted_4$3, [
            !__props.option.isLook ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_5$3, [
              vue.createElementVNode("div", {
                class: vue.normalizeClass(["zoom-out", vue.unref(nowVal) == 50 && "disabled"]),
                onClick: _cache[0] || (_cache[0] = ($event) => zoomSize(1))
              }, null, 2),
              vue.createElementVNode("span", null, vue.toDisplayString(vue.unref(nowVal)) + "%", 1),
              vue.createElementVNode("div", {
                class: vue.normalizeClass(["zoom-in", vue.unref(nowVal) == 300 && "disabled"]),
                onClick: _cache[1] || (_cache[1] = ($event) => zoomSize(2))
              }, null, 2)
            ])) : vue.createCommentVNode("", true),
            !__props.option.isStatus ? (vue.openBlock(), vue.createElementBlock("div", {
              key: 1,
              class: vue.normalizeClass(["box-scale", __props.option.isLook ? "no-click" : ""]),
              style: vue.normalizeStyle(`transform: scale(${vue.unref(nowVal) / 100});`)
            }, [
              vue.createVNode(_component_nodeWrap, {
                nodeConfig: vue.unref(nodeConfig),
                "onUpdate:nodeConfig": _cache[2] || (_cache[2] = ($event) => vue.isRef(nodeConfig) ? nodeConfig.value = $event : nodeConfig = $event),
                rootFieldPermissions: rootFieldPermissions.value,
                "onUpdate:rootFieldPermissions": _cache[3] || (_cache[3] = ($event) => rootFieldPermissions.value = $event)
              }, null, 8, ["nodeConfig", "rootFieldPermissions"]),
              _hoisted_6$3
              ...
              vue.createVNode(_component_displayNodeWrap, {
                class: "display",
                nodeConfig: vue.unref(nodeConfig),
                "onUpdate:nodeConfig": _cache[4] || (_cache[4] = ($event) => vue.isRef(nodeConfig) ? nodeConfig.value = $event : nodeConfig = $event),
                rootFieldPermissions: rootFieldPermissions.value,
                "onUpdate:rootFieldPermissions": _cache[5] || (_cache[5] = ($event) => rootFieldPermissions.value = $event)
              }, null, 8, ["nodeConfig", "rootFieldPermissions"]),
              _hoisted_7$2
            ], 6))
          ])
        ]),
        vue.createVNode(errorDialog, {
          visible: vue.unref(tipVisible),
          "onUpdate:visible": _cache[6] || (_cache[6] = ($event) => vue.isRef(tipVisible) ? tipVisible.value = $event : tipVisible = $event),
          list: vue.unref(tipList)
        }, null, 8, ["visible", "list"]),
        vue.createVNode(promoterDrawer),
        vue.createVNode(approverDrawer),
...
const nodeWrap_vue_vue_type_style_index_0_lang = "";
const _hoisted_1$2 = {
  key: 0,
  class: "node-wrap"
};
const _hoisted_2$2 = { key: 0 };
const _hoisted_3$2 = { class: "mr-5" };
...
const _hoisted_8$1 = { class: "branch-box-wrap" };
const _hoisted_9$1 = { class: "branch-box" };
const _hoisted_10$1 = { class: "condition-node" };
const _hoisted_11$1 = { class: "condition-node-box" };
const _hoisted_12$1 = ["onClick"];
const _hoisted_13$1 = { class: "title-wrapper" };
...
const _hoisted_19$1 = /* @__PURE__ */ vue.createElementVNode("div", { class: "top-left-cover-line" }, null, -1);
const _hoisted_20$1 = /* @__PURE__ */ vue.createElementVNode("div", { class: "bottom-left-cover-line" }, null, -1);
const _hoisted_21$1 = /* @__PURE__ */ vue.createElementVNode("div", { class: "top-right-cover-line" }, null, -1);
const _hoisted_22$1 = /* @__PURE__ */ vue.createElementVNode("div", { class: "bottom-right-cover-line" }, null, -1);
const _sfc_main$2 = {
  __name: "nodeWrap",
  props: {
    nodeConfig: {
  ...
  setup(__props, { emit: __emit }) {
    ...
    let showText = vue.computed(() => {
      var _a, _b, _c;
      if (props.nodeConfig.type == 1)
        return $func.arrToStr(props.nodeConfig.approvalList) || "所有人";
      if (props.nodeConfig.type == 2) {
        if (!((_a = props.nodeConfig.approvalList) == null ? void 0 : _a.length))
          return "";
        const ruleTypeDic = $func.getRuleTypeDic();
        const itemVal = props.nodeConfig.approvalList[0];
        const options = ((_b = ruleTypeDic[itemVal.type]) == null ? void 0 : _b.options) ?? [];
        const fieldNames = (_c = ruleTypeDic[itemVal.type]) == null ? void 0 : _c.fieldNames;
        return itemVal.options.map((data) => {
          const result = $func.findTreeNode(options.value, (node) => {
            return node[(fieldNames == null ? void 0 : fieldNames.value) || "value"] == data;
          });
          return result[(fieldNames == null ? void 0 : fieldNames.label) || "label"];
        }).toString();
      }
      if (props.nodeConfig.type == 3)
        return props.nodeConfig.conditionList.length > 0 ? `${props.nodeConfig.conditionList.length}个触发器` : "请设置触发器";
      return $func.copyerStr(props.nodeConfig);
    });
    let isInputList = vue.ref([]);
    ...
    vue.watch(
      ...
      ([flow, approver, copyer, condition, branch]) => {
        ...
        if ((flow == null ? void 0 : flow.flag) && flow.id === _uid) {
          const obj = lodashExports.cloneDeep(flow.value);
          approver.flag = false;
          emits("update:nodeConfig", { ...obj, fieldPermissions: flow.value.fieldPermissions });
        }
        if ((copyer == null ? void 0 : copyer.flag) && (copyer == null ? void 0 : copyer.id) === _uid) {
          copyer.flag = false;
          emits("update:nodeConfig", copyer.value);
        }
        if ((condition == null ? void 0 : condition.flag) && (condition == null ? void 0 : condition.id) === _uid) {
          condition.flag = false;
          emits("update:nodeConfig", condition.value);
        }
        if ((branch == null ? void 0 : branch.flag) && (branch == null ? void 0 : branch.id) === _uid) {
          branch.flag = false;
    ...
    const delTerm = (index, title) => {
      ...
      props.nodeConfig.conditionNodes.map((item, index2) => {
        item.priorityLevel = index2 + 1;
        item.nodeName = `${title}${index2 + 1}`;
      });
      resetConditionNodesErr();
      emits("update:nodeConfig", props.nodeConfig);
    ...
    const setPerson = (priorityLevel) => {
      ...
      const hasVal = (_b = vue.toRaw((_a = flowPermission1.value) == null ? void 0 : _a.fieldPermissions)) == null ? void 0 : _b.length;
      if (type == 1) {
        setPromoter(true);
        if (hasVal)
          return;
        const fieldPermissions2 = props.rootFieldPermissions;
        setFlowPermission({
          flag: false,
          id: _uid,
          fieldPermissions: fieldPermissions2 && fieldPermissions2.length > 0 ? fieldPermissions2 : authorityTableList.value
        });
    ...
    return (_ctx, _cache) => {
      const _component_addNode = vue.resolveComponent("addNode");
      const _component_nodeWrap = vue.resolveComponent("nodeWrap", true);
      const _directive_focus = vue.resolveDirective("focus");
      return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
        [1, 2, 3, 4].includes(__props.nodeConfig.type) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$2, [
          vue.createElementVNode("div", {
            class: vue.normalizeClass(["node-wrap-box", (__props.nodeConfig.type == 1 ? "start-node " : "") + (vue.unref(isTried) && __props.nodeConfig.error ? "active error" : "")])
          }, [
            vue.createElementVNode("div", {
              class: "title",
              style: vue.normalizeStyle(`background: rgb(${vue.unref(bgColors)[__props.nodeConfig.type]});`)
            }, [
              __props.nodeConfig.type == 1 ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2$2, vue.toDisplayString(__props.nodeConfig.nodeName), 1)) : (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
                vue.createElementVNode("span", _hoisted_3$2, [
                  __props.nodeConfig.type == 2 ? (vue.openBlock(), vue.createBlock(vue.unref(UserOutlined$1), { key: 0 })) : __props.nodeConfig.type == 3 ? (vue.openBlock(), vue.createBlock(vue.unref(ControlOutlined$1), { key: 1 })) : vue.createCommentVNode("", true)
                ]),
                vue.unref(isInput) ? vue.withDirectives((vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Input), {
                  key: 0,
                  style: { "width": "120px" },
                  class: "ant-input editable-title-input",
                  onBlur: _cache[0] || (_cache[0] = ($event) => blurEvent()),
                  onFocus: _cache[1] || (_cache[1] = ($event) => $event.currentTarget.select()),
                  value: __props.nodeConfig.nodeName,
                  "onUpdate:value": _cache[2] || (_cache[2] = ($event) => __props.nodeConfig.nodeName = $event),
                  placeholder: vue.unref(defaultText)
                }, null, 8, ["value", "placeholder"])), [
                  [_directive_focus]
                ]) : (vue.openBlock(), vue.createElementBlock("span", {
                  key: 1,
                  class: "editable-title",
                  onClick: _cache[3] || (_cache[3] = ($event) => clickEvent())
                }, vue.toDisplayString(__props.nodeConfig.nodeName), 1)),
            ...
            vue.createElementVNode("div", {
              ...
              vue.createElementVNode("div", _hoisted_4$2, [
                !vue.unref(showText) ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_5$2, "请选择" + vue.toDisplayString(vue.unref(defaultText)), 1)) : vue.createCommentVNode("", true),
                vue.createTextVNode(" " + vue.toDisplayString(vue.unref(showText)), 1)
              ]),
              vue.createVNode(vue.unref(RightOutlined$1), { class: "content-close" })
            ]),
            vue.unref(isTried) && __props.nodeConfig.error ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_6$2, [
              vue.createVNode(vue.unref(InfoCircleOutlined$1))
            ])) : vue.createCommentVNode("", true)
          ], 2),
          vue.createVNode(_component_addNode, {
            childNodeP: __props.nodeConfig.childNode,
            "onUpdate:childNodeP": _cache[4] || (_cache[4] = ($event) => __props.nodeConfig.childNode = $event)
          }, null, 8, ["childNodeP"])
        ])) : vue.createCommentVNode("", true),
        __props.nodeConfig.type == 5 ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_7$1, [
          vue.createElementVNode("div", _hoisted_8$1, [
            vue.createElementVNode("div", _hoisted_9$1, [
              vue.createElementVNode("button", {
                class: "add-branch",
                onClick: _cache[5] || (_cache[5] = ($event) => addTerm(4))
              }, "添加条件"),
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.nodeConfig.conditionNodes, (item, index) => {
                return vue.openBlock(), vue.createElementBlock("div", {
                  class: "col-box",
                  key: index
                }, [
                  vue.createElementVNode("div", _hoisted_10$1, [
                    vue.createElementVNode("div", _hoisted_11$1, [
                      vue.createElementVNode("div", {
                        class: vue.normalizeClass(["auto-judge", vue.unref(isTried) && item.error ? "error active" : ""])
                      }, [
                        index != 0 ? (vue.openBlock(), vue.createElementBlock("div", {
                          key: 0,
                          class: "sort-left",
                          onClick: ($event) => arrTransfer(index, -1)
                        }, "<", 8, _hoisted_12$1)) : vue.createCommentVNode("", true),
                        vue.createElementVNode("div", _hoisted_13$1, [
                          vue.unref(isInputList)[index] ? vue.withDirectives((vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Input), {
                            key: 0,
                            style: { "width": "120px" },
                            class: "ant-input editable-title-input",
                            onBlur: ($event) => blurEvent(index),
                            onFocus: _cache[6] || (_cache[6] = ($event) => $event.currentTarget.select()),
                            value: item.nodeName,
                            "onUpdate:value": ($event) => item.nodeName = $event
                          }, null, 8, ["onBlur", "value", "onUpdate:value"])), [
                            [_directive_focus]
                          ]) : (vue.openBlock(), vue.createElementBlock("span", {
                            key: 1,
                            class: "editable-title",
                            onClick: ($event) => clickEvent(index)
                          }, vue.toDisplayString(item.nodeName), 9, _hoisted_14$1)),
                          vue.createElementVNode("span", {
                            class: "priority-title",
                            onClick: ($event) => setPerson(item.priorityLevel)
                          }, "优先级" + vue.toDisplayString(item.priorityLevel), 9, _hoisted_15$1),
                          vue.createVNode(vue.unref(CloseOutlined$1), {
                            class: "close",
                            onClick: vue.withModifiers(($event) => delTerm(index, "条件"), ["stop"])
                          }, null, 8, ["onClick"])
                        ]),
                        index != __props.nodeConfig.conditionNodes.length - 1 ? (vue.openBlock(), vue.createElementBlock("div", {
                          key: 1,
                          class: "sort-right",
                          onClick: ($event) => arrTransfer(index)
                        }, " > ", 8, _hoisted_16$1)) : vue.createCommentVNode("", true),
                        vue.createElementVNode("div", {
                          class: "content",
                          onClick: ($event) => setPerson(item.priorityLevel)
                        }, vue.toDisplayString(vue.unref($func).conditionStr(__props.nodeConfig, index)), 9, _hoisted_17$1),
                        vue.unref(isTried) && item.error ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_18$1, [
                          vue.createVNode(vue.unref(InfoCircleOutlined$1))
                        ])) : vue.createCommentVNode("", true)
                      ], 2),
                      vue.createVNode(_component_addNode, {
                        childNodeP: item.childNode,
                        "onUpdate:childNodeP": ($event) => item.childNode = $event
                      }, null, 8, ["childNodeP", "onUpdate:childNodeP"])
                    ])
                  ]),
                  item.childNode ? (vue.openBlock(), vue.createBlock(_component_nodeWrap, {
                    key: 0,
                    nodeConfig: item.childNode,
                    "onUpdate:nodeConfig": ($event) => item.childNode = $event
                  }, null, 8, ["nodeConfig", "onUpdate:nodeConfig"])) : vue.createCommentVNode("", true),
                  index == 0 ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
                    _hoisted_19$1,
                    _hoisted_20$1
                  ], 64)) : vue.createCommentVNode("", true),
                  index == __props.nodeConfig.conditionNodes.length - 1 ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 2 }, [
                    _hoisted_21$1,
                    _hoisted_22$1
                  ], 64)) : vue.createCommentVNode("", true)
                ]);
        ...
        __props.nodeConfig.childNode ? (vue.openBlock(), vue.createBlock(_component_nodeWrap, {
          key: 2,
          nodeConfig: __props.nodeConfig.childNode,
          "onUpdate:nodeConfig": _cache[8] || (_cache[8] = ($event) => __props.nodeConfig.childNode = $event)
        }, null, 8, ["nodeConfig"])) : vue.createCommentVNode("", true)
      ], 64);
    };
  }
};
...
const _hoisted_4$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ vue.createElementVNode("span", { class: "title" }, "审批人", -1));
const _hoisted_5$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ vue.createElementVNode("span", { class: "title" }, "条件分支", -1));
const _hoisted_6$1 = {
  class: "btn",
  type: "button"
};
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$1, [
        vue.createElementVNode("div", _hoisted_2$1, [
          !vue.unref(isLook) ? (vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Popover), {
            key: 0,
            modelValue: vue.unref(visible),
            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => vue.isRef(visible) ? visible.value = $event : visible = $event),
            placement: "right"
          }, {
            content: vue.withCtx(() => [
              vue.createElementVNode("ul", _hoisted_3$1, [
                hasNode.value(2) ? (vue.openBlock(), vue.createElementBlock("li", {
                  ...
                  vue.createVNode(vue.unref(TeamOutlined$1), {
                    class: "icon",
                    style: { "color": "rgb(255, 148, 62)" }
                  }),
                  _hoisted_4$1
                ])) : vue.createCommentVNode("", true),
                hasNode.value(5) ? (vue.openBlock(), vue.createElementBlock("li", {
                  ...
                  vue.createVNode(vue.unref(ShareAltOutlined$1), {
                    class: "icon",
            ...
            default: vue.withCtx(() => [
              vue.createElementVNode("button", _hoisted_6$1, [
                vue.createVNode(vue.unref(PlusOutlined$1), { class: "iconfont" })
              ])
            ]),
            _: 1
...
const _hoisted_7 = { class: "branch-box-wrap" };
const _hoisted_8 = { class: "branch-box" };
const _hoisted_9 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("button", { class: "add-branch" }, "条件", -1));
const _hoisted_10 = { class: "condition-node" };
const _hoisted_11 = { class: "condition-node-box" };
const _hoisted_12 = { class: "mr-5" };
const _hoisted_13 = { class: "editable-title" };
const _hoisted_14 = { class: "content" };
const _hoisted_15 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "top-left-cover-line" }, null, -1));
const _hoisted_16 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "bottom-left-cover-line" }, null, -1));
const _hoisted_17 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "top-right-cover-line" }, null, -1));
const _hoisted_18 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "bottom-right-cover-line" }, null, -1));
const _hoisted_19 = {
  key: 2,
  class: "branch-wrap"
};
const _hoisted_20 = { class: "branch-box-wrap" };
const _hoisted_21 = { class: "branch-box" };
const _hoisted_22 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("button", { class: "add-branch" }, "分支", -1));
const _hoisted_23 = { class: "condition-node" };
const _hoisted_24 = { class: "condition-node-box" };
const _hoisted_25 = { class: "mr-5" };
const _hoisted_26 = { class: "editable-title" };
const _hoisted_27 = { class: "content" };
const _hoisted_28 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "top-left-cover-line" }, null, -1));
const _hoisted_29 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "bottom-left-cover-line" }, null, -1));
const _hoisted_30 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "top-right-cover-line" }, null, -1));
const _hoisted_31 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("div", { class: "bottom-right-cover-line" }, null, -1));
const _sfc_main = {
  __name: "displayNodeWrap",
  props: {
    nodeConfig: {
      type: Object,
      default: () => {
  ...
  setup(__props) {
    ...
    let showText = vue.computed(() => {
      if (props.nodeConfig.type == 1)
        return $func.arrToStr(props.nodeConfig.approvalList) || "所有人";
      if (props.nodeConfig.type == 2)
        return $func.arrToStr(props.nodeConfig.approvalList) || "直接主管";
      if (props.nodeConfig.type == 3)
        return props.nodeConfig.conditionList.length > 0 ? `${props.nodeConfig.conditionList.length}个触发器` : "请设置触发器";
      return $func.copyerStr(props.nodeConfig);
    });
    ...
    return (_ctx, _cache) => {
      const _component_addNode = vue.resolveComponent("addNode");
      const _component_displayNodeWrap = vue.resolveComponent("displayNodeWrap", true);
      return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
        [0, 1, 2, 5].includes(__props.nodeConfig.type) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
          vue.createElementVNode("div", {
            class: vue.normalizeClass(["node-wrap-box", __props.nodeConfig.type == 0 ? "start-node " : ""]),
            style: vue.normalizeStyle({ border: `1px solid ${vue.unref(bgColors)[__props.nodeConfig.completeState]}` })
          }, [
            vue.createElementVNode("div", {
              class: "title",
              style: vue.normalizeStyle({ background: vue.unref(bgColors)[__props.nodeConfig.completeState] })
            }, [
              vue.createElementVNode("span", _hoisted_2, [
                __props.nodeConfig.completeState === 1 ? (vue.openBlock(), vue.createBlock(vue.unref(ClockCircleOutlined$1), { key: 0 })) : __props.nodeConfig.completeState === 2 ? (vue.openBlock(), vue.createBlock(vue.unref(FileOutlined$1), { key: 1 })) : (vue.openBlock(), vue.createBlock(vue.unref(NodeIndexOutlined$1), { key: 2 }))
              ]),
              vue.createElementVNode("span", null, vue.toDisplayString(__props.nodeConfig.nodeName), 1)
            ], 4),
            vue.createElementVNode("div", _hoisted_3, [
              vue.createElementVNode("div", _hoisted_4, [
                !vue.unref(showText) ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_5, "请选择" + vue.toDisplayString(vue.unref(defaultText)), 1)) : vue.createCommentVNode("", true),
                vue.createTextVNode(" " + vue.toDisplayString(vue.unref(showText)), 1)
              ])
            ])
          ], 6),
        ...
        __props.nodeConfig.type == 4 ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_6, [
          vue.createElementVNode("div", _hoisted_7, [
            vue.createElementVNode("div", _hoisted_8, [
              ...
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.nodeConfig.conditionNodes, (item, index) => {
                return vue.openBlock(), vue.createElementBlock("div", {
                    ...
                    vue.createElementVNode("div", _hoisted_11, [
                      vue.createElementVNode("div", {
                        ...
                        vue.createElementVNode("div", {
                          ...
                          vue.createElementVNode("span", _hoisted_13, vue.toDisplayString(item.nodeName), 1)
                        ], 4),
                        vue.createElementVNode("div", _hoisted_14, vue.toDisplayString(vue.unref($func).conditionStr(__props.nodeConfig, index)), 1)
                      ], 4),
                      vue.createVNode(_component_addNode, {
                        childNodeP: item.childNode,
                        "onUpdate:childNodeP": ($event) => item.childNode = $event
                  ...
                  item.childNode ? (vue.openBlock(), vue.createBlock(_component_displayNodeWrap, {
                    key: 0,
                    nodeConfig: item.childNode,
                    "onUpdate:nodeConfig": ($event) => item.childNode = $event
                  }, null, 8, ["nodeConfig", "onUpdate:nodeConfig"])) : vue.createCommentVNode("", true),
            ...
            vue.createVNode(_component_addNode, {
              childNodeP: __props.nodeConfig.childNode,
              "onUpdate:childNodeP": _cache[1] || (_cache[1] = ($event) => __props.nodeConfig.childNode = $event)
            }, null, 8, ["childNodeP"])
          ])
        ])) : vue.createCommentVNode("", true),
        __props.nodeConfig.type == 3 ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_19, [
                    ...
                    vue.createElementVNode("div", _hoisted_24, [
                      vue.createElementVNode("div", {
                        ...
                        vue.createElementVNode("div", {
                          ...
                          vue.createElementVNode("span", _hoisted_26, vue.toDisplayString(item.nodeName), 1)
                        ], 4),
                        vue.createElementVNode("div", _hoisted_27, vue.toDisplayString(vue.unref($func).conditionStr(__props.nodeConfig, index)), 1)
                      ], 4),
                      vue.createVNode(_component_addNode, {
                        childNodeP: item.childNode,
                        "onUpdate:childNodeP": ($event) => item.childNode = $event
        ...
        __props.nodeConfig.childNode ? (vue.openBlock(), vue.createBlock(_component_displayNodeWrap, {
          key: 3,
          nodeConfig: __props.nodeConfig.childNode,
          "onUpdate:nodeConfig": _cache[3] || (_cache[3] = ($event) => __props.nodeConfig.childNode = $event)
        }, null, 8, ["nodeConfig"])) : vue.createCommentVNode("", true)
      ], 64);
    };
  }
...
const myPlugin = {
  ...
  install(Vue, options) {
    Vue.component("ShyFlowDingDing", _sfc_main$3);
    Vue.component("nodeWrap", _sfc_main$2);

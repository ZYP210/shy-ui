  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Modal), {
        visible: vue.unref(visibleDialog),
        "onUpdate:visible": _cache[2] || (_cache[2] = ($event) => vue.isRef(visibleDialog) ? visibleDialog.value = $event : visibleDialog = $event),
        title: "提示",
        width: 650
      }, {
        footer: vue.withCtx(() => [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Drawer), {
        ...
        "onUpdate:visible": _cache[2] || (_cache[2] = ($event) => vue.isRef(visible) ? visible.value = $event : visible = $event),
        class: "set_promoter",
        width: 550,
        title: "发起人",
        placement: "right",
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Drawer), {
        visible: vue.unref(visible),
        "onUpdate:visible": _cache[0] || (_cache[0] = ($event) => vue.isRef(visible) ? visible.value = $event : visible = $event),
        class: "set_copyer",
        width: 550,
        title: "触发器",
        placement: "right",
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(antDesignVue.Drawer), {
        visible: vue.unref(visible),
        "onUpdate:visible": _cache[1] || (_cache[1] = ($event) => vue.isRef(visible) ? visible.value = $event : visible = $event),
        class: "set_promoter",
        width: 550,
        title: "条件设置",
        placement: "right",

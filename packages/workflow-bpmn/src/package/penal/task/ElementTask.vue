<template>
  <div class="panel-tab__content">
    <Form size="small" :label-col="{ style: { width: '90px' } }">
      <FormItem label="异步延续">
        <Checkbox v-model="taskConfigForm.asyncBefore" @change="changeTaskAsync">异步前</Checkbox>
        <Checkbox v-model="taskConfigForm.asyncAfter" @change="changeTaskAsync">异步后</Checkbox>
        <Checkbox

<template>
  <div class="panel-tab__content">
    <Form :model="flowConditionForm" :label-col="{ style: 'width:90px' }" size="small">
      <FormItem label="流转类型">
      ...
      <FormItem label="条件格式" v-if="flowConditionForm.type === 'condition'" key="condition">
      ...
      <FormItem
        ...
        key="express"
      >
        <Input v-model:value="flowConditionForm.body" clearable @change="updateFlowCondition" />
      </FormItem>
      <template
      ...
      >
        ...
        <FormItem label="脚本" v-if="flowConditionForm.scriptType === 'inlineScript'" key="body">
          <Input

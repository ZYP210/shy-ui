...
const useTheme = () => {
  ...
  const getScopeAntColor = vue.computed(
  ...
  const getAntvThemeAlgorithm = vue.computed(
    () => getAntvThemeAlgorithmFn(vue.unref(getThemeType))
  );
  const getOtherScopes = vue.computed(() => {

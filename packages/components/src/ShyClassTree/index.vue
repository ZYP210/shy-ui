<template>
  <section class="shy-class-tree">
    <a-input-search v-model:value="search" placeholder="请输入查找内容" style="width: 100%" @search="onSearchHndler" />
    <a-divider />
    <div class="shy-class-tree-main">
      <a-directory-tree :showLine="treeOption.showLine" v-model:selectedKeys="treeOption.selectedKeys" :fieldNames="treeOption.fieldNames" :tree-data="props.data" @select="treeSelectHanlder">
      </a-directory-tree>
    </div>
  </section>
</template>

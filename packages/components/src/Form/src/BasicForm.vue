<template>
  ...
  >
    <Row v-bind="getRow" :class="`${prefixCls}-input`">
  ...
  <slot name="formFooter">
    <div
      ...
      v-if="
        getFormActionBindProps?.showAdvancedButton &&
        !getFormActionBindProps?.hideAdvanceBtn
      "
    >
      ...
      <span :class="getToggleClass" @click="handleToggleAdvanced"
        ><DownOutlined :style="{ fontSize: '10px', color: '#919191 ' }"
      /></span>
    </div>
  </slot>
</template>
...
export default defineComponent({
  name: 'BasicForm',
  components: { FormItem, Form, Row, FormAction, DownOutlined },
  props: basicProps,
  emits: [
    'advanced-change',
    'reset',
